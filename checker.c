...
/*   Updated: 2019/09/06 17:28:25 by sholiak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_use(void)
{
	ft_putstr("|ARG=\"digits\"; ./push_swap $ARG | ./checker $ARG|\n");
	ft_putstr("|To process 2 exe together			|\n");
	ft_putstr("|ARG=\"digits\"; ./push_swap $ARG		        |\n");
	ft_putstr("|To see output of push_swap which sorts stack   |\n");
	ft_putstr("|ARG=\"digits\"; ./checker $ARG		        |\n");
	ft_putstr("|To see if checker works			|\n");
	error("|^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^|");
}
